...
if (isset($_POST['editr'])) {
    ...
    if (isset($_FILES['researchfile1']) && $_FILES['researchfile1']['error'] === UPLOAD_ERR_OK) {
        ...
        move_uploaded_file($temp_name, "C:/xampp/htdocs/Profile-Project-main2/Home/Home-UserN/FilePDF/Research/researchfile/" . $researchfile1);
    } else {
        $researchfile1 = ''; 
    }
    ...
    if (isset($_FILES['picturediagram1']) && $_FILES['picturediagram1']['error'] === UPLOAD_ERR_OK) {
        ...
        move_uploaded_file($temp_name, "C:/xampp/htdocs/Profile-Project-main2/Home/Home-UserN/FilePDF/Research/picturediagram/" . $picturediagram1);
    } else {
