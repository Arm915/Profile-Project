...
if (!isset($_SESSION['Id'])) {
    header("Location: http://localhost/Profile-Project-main2/login_register/Login.php");
    exit();
}
...
if (array_key_exists("submitresearch", $_POST)) {
    ...
    // ที่เก็บไฟล์ PDF
    $targetdir_researchfile = "C:/xampp/htdocs/Profile-Project-main2/Home/Home-UserN/FilePDF/Research/researchfile/";
    $targetdir_picturediagram = "C:/xampp/htdocs/Profile-Project-main2/Home/Home-UserN/FilePDF/Research/picturediagram/";
    $targetdir_capitaldocuments = "C:/xampp/htdocs/Profile-Project-main2/Home/Home-UserN/FilePDF/Research/capitaldocuments/";
...
if (array_key_exists("submit2", $_POST)) {
    ...
    // ที่เก็บไฟล์ PDF
    $targetdir_performance = "C:/xampp/htdocs/Profile-Project-main2/Home/Home-UserN/FilePDF/art_service/performance_art_service/";
